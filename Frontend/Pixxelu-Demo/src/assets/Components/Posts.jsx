...
function Posts() {
  return (
    ...
    <div className='text-6xl text-center text-blue-700'>
        <h1>
            Create New Post 
        </h1>
    </div>
    ...
    <div className='flex'>
       <label className='block'> Content</label>
        <textarea className='block border-gray-600 outline-orange-500' rows={10} cols={10}>Enter Your Content Here</textarea>
    </div>
