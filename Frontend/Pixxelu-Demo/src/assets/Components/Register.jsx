...
<Link to="https://codepen.io/uidesignhub" target="_blank" title="codepen aji" className="flex absolute top-5 text-center text-gray-100 focus:outline-none"><img src="/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="aji" className="object-cover mx-auto w-8 h-8 rounded-full "/><p className="text-xl ml-3">aji<strong>mon</strong></p> </Link>
          ...
          <form className="mt-8 space-y-6" action="#" method="POST">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <label for="remember_me" classNameName="ml-2 block text-sm text-gray-900">
                  Remember me
                </label>
              </div>
            ...
            <p className="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
              ...
              <Link to="#" className="text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Sign
                up</Link>
            </p>
          </form>
        </div>
